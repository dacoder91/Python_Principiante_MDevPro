...
# my_tuple[0] = 10 //No se puede modificar un valor de una tupla 
...
# my_tuple = (100) asi no, ya qu est es solo definir una variable llamada my_tuple con valor 100
my_tuple = (100,)
print(my_tuple)