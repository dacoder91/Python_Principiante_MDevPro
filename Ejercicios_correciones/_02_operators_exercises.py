...
num = 7
print("Mi numero favorito es:" + str(num))
...
print(not( 15 > 20))
# 10. Combina operadores aritméticos y lógicos: Verifica si el número resultante de la expresión (5 * 3) + 2
# es mayor que 10 y menor que 20. Imprime el resultado.
num = ((5*3)+2)
